...
//#include "cblas_f77.h"
#include "blas_api.h"
void API_SUFFIX(cblas_dgemmr)(const CBLAS_LAYOUT layout, const CBLAS_TRANSPOSE TransA,
                 ...
                 const double beta, double  *C, const CBLAS_INT ldc)
{
   ...
   if( layout == CblasColMajor )
   {
      ...
      dgemmr_ (F77_TA, F77_TB, &F77_M, &F77_N, &F77_K, &alpha, A,
   ...
   } else if (layout == CblasRowMajor)
   {
      ...
      dgemmr_ (F77_TA, F77_TB, &F77_N, &F77_M, &F77_K, &alpha, B,
